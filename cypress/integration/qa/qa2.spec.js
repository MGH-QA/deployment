  ...
  describe('Authentication', () => {
    it('Login with Alsid for AD', () => {
      ...
      cy.get('input[name="password"]')
        .type('xDgfUBLh6WYiqaQPzv0AH13d9XIZrFb8')
        .should('have.value', 'xDgfUBLh6WYiqaQPzv0AH13d9XIZrFb8')
      ...
      cy.get('input[name="login"]')
        ...
        .should('have.value', 'ALSID\\dcadmin')
      cy.get('input[name="password"]')
        .type('plDTPNJySMWh4EciQBHIzkCgxAsd13fY')
        .should('have.value', 'plDTPNJySMWh4EciQBHIzkCgxAsd13fY')
        cy.get('[attr-name="ContainerFooter"]')
        .contains('Add')
        .click()
        .wait(5000)
      ...
      cy.get('input[name="login"]')
        ...
        .should('have.value', 'ALSID\\dcadmin')
      cy.get('input[name="password"]')
        .type('CoDtVw1IKa3yupYxHj8FeqAPrJlQZRiM')
        .should('have.value', 'CoDtVw1IKa3yupYxHj8FeqAPrJlQZRiM')
        cy.get('[attr-name="ContainerFooter"]')
        .contains('Add')
        .click()
        .wait(5000)
      ...
      cy.get('input[name="smtpAccount"]')
        .type('3d4523b7945248')
        .should('have.value', '3d4523b7945248')
      cy.get('input[name="smtpAccountPassword"]')
        .type('cfbb5aa5b6b0ad')
        .should('have.value', 'cfbb5aa5b6b0ad')
