  ...
  describe('Authentication', () => {
    it('Login with Alsid for AD', () => {
      ...
      cy.get('input[name="password"]')
        .type('WgVwL7utoRPK3zZSmx1nfGHMQOsldDaJ')
        .should('have.value', 'WgVwL7utoRPK3zZSmx1nfGHMQOsldDaJ')
      ...
      cy.get('input[name="login"]')
        ...
        .should('have.value', 'ALSID\\dcadmin')
      cy.get('input[name="password"]')
        .type('V0EUgDGhtrsu5CwXbczK8NQiMl6j3n9R')
        .should('have.value', 'V0EUgDGhtrsu5CwXbczK8NQiMl6j3n9R')
        cy.get('[attr-name="ContainerFooter"]')
        .contains('Add')
        .click()
        .wait(5000)
      ...
      cy.get('input[name="login"]')
        ...
        .should('have.value', 'ALSID\\dcadmin')
      cy.get('input[name="password"]')
        .type('yJUD3SdeVaZsf9OtvgFKi48mLcwABuH6')
        .should('have.value', 'yJUD3SdeVaZsf9OtvgFKi48mLcwABuH6')
        cy.get('[attr-name="ContainerFooter"]')
        .contains('Add')
        .click()
        .wait(5000)
